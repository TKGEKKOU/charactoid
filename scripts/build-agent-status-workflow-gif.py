...
for path in files:
    ...
    d.rounded_rectangle((102,13,fw-24,41),radius=14,fill='#dfe7ee'); d.text((120,19),'127.0.0.1:18000  ·  CHARACTOID',fill='#536579'); browser.paste(content,(0,chrome)); canvas.paste(browser,(x,y)); frames.append(canvas.convert('P',palette=Image.Palette.ADAPTIVE,colors=192))
