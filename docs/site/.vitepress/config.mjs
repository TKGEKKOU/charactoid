...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      section('设计', [
        { text: '产品总览', link: '/concepts/overview' },
        { text: '任务生命周期', link: '/concepts/lifecycle' },
        { text: '系统架构', link: '/concepts/architecture' },
        { text: '源码地图', link: '/concepts/source-map' },
        { text: '术语表', link: '/concepts/glossary' },
        { text: '内置 Runtime', link: '/concepts/runtime' },
        { text: '持久化', link: '/concepts/persistence' },
      ...
      section('参考', [
        ...
        { text: '资源与 Provider API', link: '/reference/api-resources' },
        { text: '系统与诊断 API', link: '/reference/api-system' },
