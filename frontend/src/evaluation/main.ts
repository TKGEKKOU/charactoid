...
export function showEvaluationApp() { root()?.dispatchEvent(new CustomEvent("charactoid:evaluation-show")); }
export function hideEvaluationApp() { root()?.dispatchEvent(new CustomEvent("charactoid:evaluation-hide")); }
