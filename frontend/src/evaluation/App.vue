...
import EvalDatasetPanel from "./EvalDatasetPanel.vue";
import EvalCandidatePanel from "./EvalCandidatePanel.vue";
import { toEvalRunPayload, type EvalDatasetMode } from "./dataset";

const personas = ref<any[]>([]); const personaId = ref(""); const tier = ref("fast"); const datasetMode = ref<EvalDatasetMode>("generated");
